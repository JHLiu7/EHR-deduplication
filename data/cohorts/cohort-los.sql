...
select 
    iv.SUBJECT_ID, iv.HADM_ID, iv.ICUSTAY_ID, iv.INTIME, t.DISCHARGE_TIME, 
    case 
      when (l.LOS_HOUR_REST - 48)/24 < 21 then (l.LOS_HOUR_REST - 48)/24 
      else 21
    end as LOS_DAY
from icu_view iv
...
where
    a.age > 15 and l.LOS_HOUR_REST > (48 + 24) # pred window + 24hr
order by 
    iv.SUBJECT_ID, iv.HADM_ID, iv.ICUSTAY_ID



# 37305 queried on 10/18/2021
